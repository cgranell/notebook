...
---
class: center, middle
## A breaf introdueciotn along with resources and links about SOA, web services, REST, and restful services
...
* [APIs](http://www.programmableweb.com/apis/directory) for client-side applications quickly proliferated to access restful web services. 
    * Big players (Amazon, google, Esri, ...) only offers restful API 
