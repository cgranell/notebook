...
* Creemos que la revolución mental es un efecto de la revolución tecnológiva, y en cambio deberíamos entender que lo contrario es la verdad. Primero la revolución mentla, luego la tecnológica. Creemos que lo ordenadores han generado una nueva forma de inteligencia; invertid la secuencia: un nuevo tipo de inteligencia ha generado los ordenadores (una cierta mutación mental se ha dotado de los instrumentos adecuados para su modo de estar en el mundo y lo ha hecho a gran velocidad). 
...
### Summary
* (Chapter 3 Planning and Urban Design) List of features of healthy communicaty on pages 55-58. Pedestrians are vey sensitive to street desings and traffic. Indeed, walking behabiour is highly dependent on the built environment .
* (Chapter 11 Mental Health, Stressors, and Health Care Environment) The built environment might be affecting the level of stress. At the beginning of 20th century, the concept of [anomie](https://en.wikipedia.org/wiki/Anomie) came out to reflect how immigration affect mental health. It refers to psychological dislocation of rural immigrants into cities, *newcommers* (to cities) who have a surplus of contact with strangers. Another related concept is [biophilia](https://en.wikipedia.org/wiki/Biophilia_hypothesis) or the lack of contacts with nature. People had less or no access to green spaces, parks, and natural environments. Another concern is the [Newman's theory of defensible space](https://en.wikipedia.org/wiki/Defensible_space_theory). A defensible space is "a residential environment whose physical characteristics—building layout and site plan—function to allow inhabitants themselves to become key agents in ensuring their security". Evidence supports the idea of small-scale, pedestrian-friendly environments are best for promotong health nad socialisation.
* (Chapter 12 Social Capital) The built and the social environment can assist people to avoid risk behaviour or to promote healthy lifestyle. [Social capital](https://en.wikipedia.org/wiki/Social_capital) is a group level variable. Individuals may decide appropriate behavior based on clues in teh built environemnt arond them (e.g. [broken windows theory by James Wilson](https://en.wikipedia.org/wiki/Broken_windows_theory)). 
